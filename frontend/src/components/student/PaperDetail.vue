<template>
	<div>
		...
		<el-row>
			<el-col :span="4" class="logo"><i class="el-icon-s-order">
				</i>
				<span class="title">
					在线考试系统
				</span>
          ...
          ">
			...
			<el-col :span="2" class="user" offset="4"><i class="el-icon-user-solid">
					{{ userName }}
				</i>
			</el-col>
		</el-row>
				...
				<el-row>
					<el-col span="8">
						<el-card class="left">
							<b>题目作答情况</b>
							<div class="aboutAns">
								<el-button round v-for="(item, index) in paper" :key="index" style="margin: 5px"
									@click="selectQuestion(index)" :type="bottonType(index)">{{ index + 1 }}</el-button>
							</div>
							<!-- <el-button type="primary" style="margin: 50px auto; display: block" @click="submit()"> -->
							<el-button type="primary" style="margin: 50px auto; display: block" @click="beforeSubmit()">
								结束考试
							</el-button>
						</el-card>
					</el-col>
					<el-col span="16">
						<el-card class="right">
							<div class="questionDetail">
								...
								<li>
									<el-button round :type="selectButton[0]" @click="chooseAns('A')">A</el-button>
									<span>{{ nowA }}</span>
								</li>
								<li>
									<el-button round :type="selectButton[1]" @click="chooseAns('B')">B</el-button>
									<span>{{ nowB }}</span>
								</li>
								<li>
									<el-button round :type="selectButton[2]" @click="chooseAns('C')">C</el-button>
									<span>{{ nowC }}</span>
								</li>
								<li>
									<el-button round :type="selectButton[3]" @click="chooseAns('D')">D</el-button>
									<span>{{ nowD }}</span>
								</li>
							</div>
						</el-card>
