          ...
          <el-table-column label="操作" min-width="25%">
            <template slot-scope="scope">
              ...
              <el-button
                type="danger"
                class="delete"
                @click.native.prevent="beforeDelete(scope.row.id)"
              >
                删除
              </el-button>
            </template>
          ...
          <el-dialog title="添加题目" :visible.sync="dialogFormVisible">
            <el-form>
              ...
              <el-form-item label="题目答案:" :label-width="formLabelWidth">
                <el-select v-model="questionAdd.answer" style="width: 100%">
                  <el-option :label="A" value="A"></el-option>
                  <el-option :label="B" value="B"></el-option>
                  <el-option :label="C" value="C"></el-option>
                  <el-option :label="A" value="D"></el-option>
                </el-select>
              </el-form-item>
            </el-form>
        ...
        <div id="edit">
          <el-dialog title="编辑题目" :visible.sync="dialogFormEditVisible">
            <el-form>
              ...
              <el-form-item label="题目答案:" :label-width="formLabelWidth">
                <el-select v-model="nowEdit.answer" style="width: 100%">
                  <el-option :label="A" value="A"></el-option>
                  <el-option :label="B" value="B"></el-option>
                  <el-option :label="C" value="C"></el-option>
                  <el-option :label="A" value="D"></el-option>
