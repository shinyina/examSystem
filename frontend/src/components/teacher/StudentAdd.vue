    ...
    <el-row>
      ...
      <el-col span="18">
        ...
        >
          ...
          <el-table-column prop="nickname" label="姓名" min-width="25%">
          </el-table-column>
          ...
          <el-dialog title="编辑" :visible.sync="dialogFormEditVisible">
            ...
            <div slot="footer" class="dialog-footer">
              <el-button @click="dialogFormEditVisible = false"
                >取 消</el-button
              >
              <el-button type="primary" @click="studentEdit()"
                >确 定</el-button
              >
            </div>
          </el-dialog>
...
export default {
  ...
  data() {
    return {
      ...
      newStudent: { nickname: "", username: "", password: "" },
      form: {
        name: "",
        delivery: false,
        type: [],
